$(function() {
    ...
    let myGenre = document.getElementById("chartDrop");
    ...
    let myTimeframe = document.getElementById("timeframeDrop");
    ...
    let prevDate = printDate.subtract(7,'d');
    let prevString = "location.href='fullchart.html?chart=" + pChart + "&cname=" + encodeURIComponent(pName) + "&first=" + pFirst + "&last=" + pLast + "&date=" + prevDate.format('YYYY-MM-DD') + "&genre=" + pGenre + "'";
    ...
    let startDate = document.getElementById('timeframeDrop').getAttribute('data-firstDate');
    let endDate = document.getElementById('timeframeDrop').getAttribute('data-lastDate'); 
    let curDate = document.getElementById('timeframeDrop').getAttribute('data-curDate');
